...
SYSTEM_PROMPT = (
    ...
    "- schedule_background_task: ایجاد یادآور، تایمر، و کارهای زمان‌بندی‌شده (cron)\n\n"
    "## اصول کاری:\n\n"
...
_TOOL_KEYWORDS = [
    ...
    # پس‌زمینه و یادآوری
    "یادآوری", "تایمر", "زمانبندی", "پس‌زمینه", "پس زمینه", "cron", "background", "timer", "reminder", "یاداوری", "یادآور", "چک کن", "سایت", "بفرست"
]
